...
if check_password():
    ...
    # NEW: Detect Year from Folder Path or Filename
...
"""
        ...
        try:
            ...
            if cpt_row_idx != -1:
                for col in df.columns[4:]: 
                    ...
                    if target_year and valid_date and valid_date.year != target_year: continue # STRICT YEAR FILTER
    ...
    def process_files(file_objects):
        ...
        for file_obj in all_files_to_process:
            ...
            # --- CONTEXT DETECTION ---
            # Extract 2025/2026 from folder/filename (e.g., "DEC25" -> 2025)
